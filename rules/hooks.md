...
## 当前 Hooks (Current Hooks) (在 ~/.claude/settings.json 中)

### PreToolUse
- **tmux reminder**: 针对长时间运行的命令（npm, pnpm, yarn, cargo 等）建议使用 tmux
...
### Stop
- **console.log audit**: 会话结束前检查所有修改的文件是否存在 console.log
