---
name: clickhouse-io
description: ClickHouse 数据库模式、查询优化、分析以及用于高性能分析工作负载的数据工程最佳实践。
---
...
-- ✅ 使用 quantile 进行百分位数计算 (比 percentile 更高效)
SELECT
...
## 常见分析查询 (Common Analytics Queries)
